<?php
/**
 * Campo San Isidro — Shop Archive (Todos los productos)
 */
get_header();
...
<div class="csi-cat-hero">
    <div class="csi-container">
        ...
        <h1 class="csi-cat-hero__title">Todos los productos</h1>
        <p class="csi-cat-hero__desc">Embutidos y fiambres artesanales elaborados en Garupá, Misiones</p>
...
<div class="csi-cat-filter-bar">
    <div class="csi-container">
        <a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class="csi-tab is-active">Todos</a>
        <?php foreach ($all_cats as $cat):
            if ($cat->name === 'Uncategorized') continue;
        ?>
        <a href="<?php echo esc_url(get_term_link($cat)); ?>" class="csi-tab">
...
<section class="csi-section">
    <div class="csi-container">
        ...
        <?php else: ?>
        <p style="color:var(--text-muted);text-align:center;padding:60px 0;">No hay productos disponibles.</p>
        <?php endif; ?>
    </div>
</section>
